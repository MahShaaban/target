---
title: "Using `target` to predict cooperative and competitive binding"
author: "Mahmoud Ahmed"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Using target to predict cooperative and competitive binding}
...
by cumulative distribution function of the rank product of their targets. Finally,
When the targets are predicted based on the two statistics combined, the sign of
the statistics product determines the direction of the factor interactions. Here,
more higher ranking transcripts had positive/red/cooperative change associated 
